                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="nivel" id="" class="form-control">
                                                <option value="TECNICO"<?php if($nivel=='TECNICO'){ ?> selected="selected" <?php } ?>>TECNICO</option>
                                                <option value="TECNOLOGO"<?php if($nivel=='TECNOLOGO'){ ?> selected="selected" <?php } ?>>TECNOLOGO</option>
                                                <option value="PROFESIONAL"<?php if($nivel=='PROFESIONAL'){ ?> selected="selected" <?php } ?>>PROFESIONAL</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
